...
public record NewsletterStatusResponse(
   ...
   *
   * <p>PENDING : 0% (대기 중) TODO: OCR 진행률 따로, 번역, 요약 진행률 따로 PROCESSING : 60% (OCR/번역/요약 진행 중)
   * COMPLETED : 100% (완료) FAILED : 0% (실패, errorMessage에 사유 포함)
   *
   * <p>TODO: 현재는 고정값으로 처리, 추후 AI 서버에서 단계별 진행률을 받아 세분화 예정
   */
