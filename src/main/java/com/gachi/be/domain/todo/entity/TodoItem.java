...
/**
 * 해야 할 일 항목 엔티티.
 * OpenAI가 가정통신문에서 날짜 기반으로 추출한 행동 계획.
 * - content: "담임 선생님께 동의서 직접 제출"
 *   targetDate: 2026-05-15 (null 도 가능하게 처리) / targetDateLabel: "5월 15일"
 * targetDate: 실제 날짜가 명시된 경우. 캘린더 연동에 사용.
