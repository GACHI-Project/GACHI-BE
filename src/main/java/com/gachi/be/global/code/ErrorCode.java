...
public enum ErrorCode {
    ...
    METHOD_NOT_ALLOWED(HttpStatus.METHOD_NOT_ALLOWED, "COMMON4002", "지원하지 않는 HTTP 메서드입니다.", "허용되지 않은 메서드 요청", ErrorLogLevel.WARN),
    BUSINESS_RULE_VIOLATION(HttpStatus.BAD_REQUEST, "BUS4001", "비즈니스 규칙 위반입니다.", "도메인 정책 위반", ErrorLogLevel.WARN),
    RESOURCE_NOT_FOUND(HttpStatus.NOT_FOUND, "COMMON4041", "요청한 리소스를 찾을 수 없습니다.", "요청 경로에 해당하는 리소스 없음", ErrorLogLevel.INFO),
