...
public class S3Config {
  ...
  /** S3Presigner 빈 클로바 OCR 연동 시 Presigned URL을 생성할 때 사용 예정. Base64 대신 URL로 전달. */
  @Bean
  ...
  /**
   * 자격증명 공급자 결정. 환경변수 두 값이 모두 있으면 StaticCredentialsProvider, 없으면 DefaultCredentialsProvider로 자동 탐색.
   */
